      ...
      <section className="container mx-auto py-20 px-4">
        ...
        {loading ? (
            <div className="text-center py-10">
               ...
               <p className="mt-2 text-gray-500">Loading amazing animals for you...</p>
            </div>
        ) : (
        ...
        <div className="text-center mt-12">
            <Link href="/animals" className="btn btn-outline border-orange-600 text-orange-600 hover:bg-orange-600 hover:border-orange-600 px-10">
                See All Animals
            </Link>
        </div>
      </section>
